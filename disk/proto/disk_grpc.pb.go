...
func (c *areaManagerClient) Create(ctx context.Context, in *CreateAreaRequest, opts ...grpc.CallOption) (*CreateAreaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.AreaManager/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AreaManager_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AreaManager/Create",
	}
...
func _AreaManager_ListUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AreaManager/ListUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *userManagerClient) Add(ctx context.Context, in *AddUserRequest, opts ...grpc.CallOption) (*AddUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.UserManager/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserManager_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.UserManager/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *shapeManagerClient) Move(ctx context.Context, in *MoveShapeRequest, opts ...grpc.CallOption) (*MoveShapeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.ShapeManager/Move", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ShapeManager_Move_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ShapeManager/Move",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ShapeManager_serviceDesc = grpc.ServiceDesc{
	ServiceName: "proto.ShapeManager",
